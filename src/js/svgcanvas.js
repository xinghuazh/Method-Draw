...
$.SvgCanvas = function (container, config) {
  ...
  var addSvgElementFromJson = this.addSvgElementFromJson = function (data) {
    console.log("addSvgElementFromJson", data);
  ...
  (function () {
    ...
    */
    ...
    var dblClick = function (evt) {
      ...
      // Reset context
      if (tagName === "ellipse" || tagName === "D" || tagName === "line" || tagName === "rect") {
  ...
  this.setSvgString = function (xmlString) {
    try {
      ...
      $("#canvas_width").val(this.contentW.toFixed(2))
      $("#canvas_height").val(this.contentH.toFixed(2))
